...
\begin{enumerate}
  ...
  \reply{Clarify that we calculate the $L^2$-orthogonal projection onto the subspaces... @Tim}
...
\begin{enumerate}
  ...
  (1.3)?
  \reply{it requires (1.3), we have added it in the beginning of Sec. 3.1}
  ...
  \reply{See above: Clarify that we calculate the $L^2$-orthogonal projection onto the subspaces... @Tim}
