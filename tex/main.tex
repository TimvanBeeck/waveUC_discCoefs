...
\jp{We remark that the condition on the time in \cref{eq:Tcondition} is the same as the one in the classical unique continuation result of Tataru for a smooth coefficient $c$.}
