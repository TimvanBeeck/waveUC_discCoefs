...
and the jump is defined\textsuperscript{1}\footnotemark \footnotetext{\textsuperscript{1}And anologously for vector-valued functions.} as $\jump{u}_{\Gamma} = u_{+}-u_{-}$ with $u_{\pm}$ being the traces 
...
~\jp{We need to setup some reproduction material.}
