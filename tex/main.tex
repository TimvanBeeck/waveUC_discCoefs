...
\noindent Figure \ref{fig:jumpCoefs:contrast:2.5} shows that for $T$ large enough, the errors $\Vert u - u_h \Vert_{L^\infty(0,T;L^2(\Omega_R))}$ and $\Vert \partial_t (u - u_h) \Vert_{L^2(0,T;L^2(\Omega_R))}$ converge with order $\mathcal{O}(h^k)$. In contrast, if $T$ is chosen too small such that the GCC is not satisfied, the errors do not converge optimally. 
...
\begin{figure}[!htbp]
    \begin{center}
        \begin{tikzpicture}[scale=0.72]
            ...
            \nextgroupplot[width=8cm,height=6.2cm,domain=1:4,xmode=linear,ymode=log, ylabel={}, xlabel={$L$}, title={$T=0.5$, $\Vert (u - u_h) \Vert_{L^\infty(0,T;L^2(\Omega_R))}$}, %cycle list name=, 
            ...
            \nextgroupplot[width=8cm,height=6.2cm,domain=1:4,xmode=linear,ymode=log, ylabel={}, xlabel={$L$}, title={$T = 0.5$, $\Vert \partial_t (u - u_h) \Vert_{L^2(0,T;L^2(\Omega_R))}$}, %cycle list name=, 
            legend pos=south west, %yticklabels={,,},
            ]
            ...
            \legend{$k=2 $,, $k = 3$,}
            \nextgroupplot[width=8cm,height=6.2cm,domain=1:4,xmode=linear,ymode=log, ylabel={}, xlabel={$L$}, title={$T = 0.1$, $\Vert (u - u_h) \Vert_{L^\infty(0,T;L^2(\Omega))}$}, %cycle list name=, 
            legend pos=south west, %yticklabels={,,},
            ]
            ...
            \nextgroupplot[width=8cm,height=6.2cm,domain=1:4,xmode=linear,ymode=log, ylabel={}, xlabel={$L$}, title={$T = 0.1$, $\Vert \partial_t (u - u_h) \Vert_{L^2(0,T;L^2(\Omega))}$}, %cycle list name=, 
            legend pos=south west, %yticklabels={,,},
            ]
            %L2-L2-u_t (k = 2)
