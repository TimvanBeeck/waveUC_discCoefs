...
This is in full agreement with the discussion in the beginning of this subsection: the Lipschitz stability result of \cref{assum:LipschitzStability} cannot hold for $\dis(\bar{\omega}_0,\Gamma) > 0$. The stability is of logarithmic type as asserted by  \cref{thm:filippas} (Thm. 5.19 of \cite{Filippas22}) and this is exemplified in our numerical experiments by the observation that the convergence rate drops to logarithmic type as $\ell$ increases.
}
